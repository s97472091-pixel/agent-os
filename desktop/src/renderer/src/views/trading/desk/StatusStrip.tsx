 ...
 * The pill rests still: switching slides the thumb, and entering Trading
 * gets the one-shot highlight from the shell's entrance. Arrow keys move
 * between the two, as a tab list should.
 */
